---
layout: release
title: "Version 2.291.0.0"
description: "SimpleSportsCaster Version 2.291.0.0"
...
### [Version 2.291.0.0 (November 11, 2020)]({{page.url}})
* Fix format exception when handling unknown media subtypes.
* Add friendly name strings for all known media subtypes.
