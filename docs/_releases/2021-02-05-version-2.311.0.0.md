---
layout: release
title: "Version 2.311.0.0"
description: "SimpleSportsCaster Version 2.311.0.0"
date: "2021-02-05 09:00:00 -0800"
author: AdamZofware
version: 1.0.0
comments: true
...
### [Version 2.311.0.0 (February 5, 2021)]({{page.url}})

* Mitigate a crash on startup due to database corruption.
* Show the elapsed time after transcoding a previously recorded video.
